...
module.exports = {
  ...
  construct: function (self, options) {
    ...
    self.afterSave = function (req, piece, options, callback) {
      ...
      if ((piece._originalFaviconRelationship && JSON.stringify(piece._originalFaviconRelationship) !== JSON.stringify(compare) && piece.aposFavicon.items[0] !== undefined) || piece._originalFaviconRelationship === undefined) {
