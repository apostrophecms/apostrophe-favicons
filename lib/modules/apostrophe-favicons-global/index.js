...
module.exports = {
  ...
  construct: function (self, options) {
    ...
    let tempDir = options.tempDir || 'tempAposFavicons';
    let faviconFields = [
      {
        name: 'aposFavicon',
        label: 'Favicon Image',
    ...
    self.afterSave = function (req, piece, options, callback) {
      ...
      if (JSON.stringify(piece._originalFaviconRelationship) !== JSON.stringify(compare) && piece.aposFavicon.items[0] !== undefined) {
        ...
        // console.log(tempDir + '/something.jpg');
        // console.log('========');
        // console.log(__dirname + '/' + tempDir + '/something.jpg');
